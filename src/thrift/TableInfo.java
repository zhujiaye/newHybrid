            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mColumns = new ArrayList<ColumnInfo>(_list8.size);
                ColumnInfo _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new ColumnInfo();
                  _elem9.read(iprot);
                  struct.mColumns.add(_elem9);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mPrimaryKeyPos = new ArrayList<Integer>(_list11.size);
                int _elem12;
                for (int _i13 = 0; _i13 < _list11.size; ++_i13)
                {
                  _elem12 = iprot.readI32();
                  struct.mPrimaryKeyPos.add(_elem12);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TableInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.mColumns != null) {
        oprot.writeFieldBegin(M_COLUMNS_FIELD_DESC);
        {
          ...
          for (ColumnInfo _iter14 : struct.mColumns)
          {
            _iter14.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.mPrimaryKeyPos != null) {
        oprot.writeFieldBegin(M_PRIMARY_KEY_POS_FIELD_DESC);
        {
          ...
          for (int _iter15 : struct.mPrimaryKeyPos)
          {
      ...
      if (struct.isSetMColumns()) {
        {
          ...
          for (ColumnInfo _iter16 : struct.mColumns)
          {
            _iter16.write(oprot);
          }
        }
      ...
      if (struct.isSetMPrimaryKeyPos()) {
        {
          ...
          for (int _iter17 : struct.mPrimaryKeyPos)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.mColumns = new ArrayList<ColumnInfo>(_list18.size);
          ColumnInfo _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = new ColumnInfo();
            _elem19.read(iprot);
            struct.mColumns.add(_elem19);
          }
        }
        struct.setMColumnsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.mPrimaryKeyPos = new ArrayList<Integer>(_list21.size);
          int _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = iprot.readI32();
            struct.mPrimaryKeyPos.add(_elem22);
          }
        }
        struct.setMPrimaryKeyPosIsSet(true);
      }
