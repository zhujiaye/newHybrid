            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mColumns = new ArrayList<ColumnInfo>(_list0.size);
                ColumnInfo _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new ColumnInfo();
                  _elem1.read(iprot);
                  struct.mColumns.add(_elem1);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mPrimaryKeyPos = new ArrayList<Integer>(_list3.size);
                int _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = iprot.readI32();
                  struct.mPrimaryKeyPos.add(_elem4);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TableInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.mColumns != null) {
        oprot.writeFieldBegin(M_COLUMNS_FIELD_DESC);
        {
          ...
          for (ColumnInfo _iter6 : struct.mColumns)
          {
            _iter6.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.mPrimaryKeyPos != null) {
        oprot.writeFieldBegin(M_PRIMARY_KEY_POS_FIELD_DESC);
        {
          ...
          for (int _iter7 : struct.mPrimaryKeyPos)
          {
      ...
      if (struct.isSetMColumns()) {
        {
          ...
          for (ColumnInfo _iter8 : struct.mColumns)
          {
            _iter8.write(oprot);
          }
        }
      ...
      if (struct.isSetMPrimaryKeyPos()) {
        {
          ...
          for (int _iter9 : struct.mPrimaryKeyPos)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.mColumns = new ArrayList<ColumnInfo>(_list10.size);
          ColumnInfo _elem11;
          for (int _i12 = 0; _i12 < _list10.size; ++_i12)
          {
            _elem11 = new ColumnInfo();
            _elem11.read(iprot);
            struct.mColumns.add(_elem11);
          }
        }
        struct.setMColumnsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.mPrimaryKeyPos = new ArrayList<Integer>(_list13.size);
          int _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = iprot.readI32();
            struct.mPrimaryKeyPos.add(_elem14);
          }
        }
        struct.setMPrimaryKeyPosIsSet(true);
      }
