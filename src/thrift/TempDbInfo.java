            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mTempTablesInfo = new ArrayList<TempTableInfo>(_list16.size);
                TempTableInfo _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new TempTableInfo();
                  _elem17.read(iprot);
                  struct.mTempTablesInfo.add(_elem17);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TempDbInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.mTempTablesInfo != null) {
        oprot.writeFieldBegin(M_TEMP_TABLES_INFO_FIELD_DESC);
        {
          ...
          for (TempTableInfo _iter19 : struct.mTempTablesInfo)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetMTempTablesInfo()) {
        {
          ...
          for (TempTableInfo _iter20 : struct.mTempTablesInfo)
          {
            _iter20.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.mTempTablesInfo = new ArrayList<TempTableInfo>(_list21.size);
          TempTableInfo _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new TempTableInfo();
            _elem22.read(iprot);
            struct.mTempTablesInfo.add(_elem22);
          }
        }
        struct.setMTempTablesInfoIsSet(true);
      }
