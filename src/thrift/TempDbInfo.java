            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mTempTablesInfo = new ArrayList<TempTableInfo>(_list24.size);
                TempTableInfo _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new TempTableInfo();
                  _elem25.read(iprot);
                  struct.mTempTablesInfo.add(_elem25);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TempDbInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.mTempTablesInfo != null) {
        oprot.writeFieldBegin(M_TEMP_TABLES_INFO_FIELD_DESC);
        {
          ...
          for (TempTableInfo _iter27 : struct.mTempTablesInfo)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetMTempTablesInfo()) {
        {
          ...
          for (TempTableInfo _iter28 : struct.mTempTablesInfo)
          {
            _iter28.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.mTempTablesInfo = new ArrayList<TempTableInfo>(_list29.size);
          TempTableInfo _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new TempTableInfo();
            _elem30.read(iprot);
            struct.mTempTablesInfo.add(_elem30);
          }
        }
        struct.setMTempTablesInfoIsSet(true);
      }
