              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.operations = new ArrayList<Operation>(_list40.size);
                  Operation _elem41;
                  for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                  {
                    _elem41 = new Operation();
                    _elem41.read(iprot);
                    struct.operations.add(_elem41);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, replay_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.operations != null) {
          oprot.writeFieldBegin(OPERATIONS_FIELD_DESC);
          {
            ...
            for (Operation _iter43 : struct.operations)
            {
              _iter43.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetOperations()) {
          {
            ...
            for (Operation _iter44 : struct.operations)
            {
              _iter44.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.operations = new ArrayList<Operation>(_list45.size);
            Operation _elem46;
            for (int _i47 = 0; _i47 < _list45.size; ++_i47)
            {
              _elem46 = new Operation();
              _elem46.read(iprot);
              struct.operations.add(_elem46);
            }
          }
          struct.setOperationsIsSet(true);
        }
