...
public class WorkerService {
  ...
  public interface Iface {
    ...
    public void replay(List<Operation> operations) throws DbmsException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void replay(List<Operation> operations, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void replay(List<Operation> operations) throws DbmsException, org.apache.thrift.TException
    {
      send_replay(operations);
      recv_replay();
    }

    public void send_replay(List<Operation> operations) throws org.apache.thrift.TException
    {
    ...
    public void recv_replay() throws DbmsException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void replay(List<Operation> operations, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      replay_call method_call = new replay_call(operations, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class replay_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public replay_call(List<Operation> operations, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class replay<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, replay_args, Void> {
      ...
      public void start(I iface, replay_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.replay(args.operations,resultHandler);
      }
    }
  ...
  public static class replay_args implements org.apache.thrift.TBase<replay_args, replay_args._Fields>, java.io.Serializable, Cloneable, Comparable<replay_args>   {
    ...
    public List<Operation> operations; // required
    ...
    public replay_args(replay_args other) {
      if (other.isSetOperations()) {
        List<Operation> __this__operations = new ArrayList<Operation>(other.operations.size());
        for (Operation other_element : other.operations) {
          __this__operations.add(new Operation(other_element));
        }
    ...
    public java.util.Iterator<Operation> getOperationsIterator() {
      return (this.operations == null) ? null : this.operations.iterator();
    }

    public void addToOperations(Operation elem) {
    ...
    public replay_args setOperations(List<Operation> operations) {
      this.operations = operations;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.operations = new ArrayList<Operation>(_list48.size);
                  Operation _elem49;
                  for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                  {
                    _elem49 = new Operation();
                    _elem49.read(iprot);
                    struct.operations.add(_elem49);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, replay_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.operations != null) {
          oprot.writeFieldBegin(OPERATIONS_FIELD_DESC);
          {
            ...
            for (Operation _iter51 : struct.operations)
            {
              _iter51.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetOperations()) {
          {
            ...
            for (Operation _iter52 : struct.operations)
            {
              _iter52.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.operations = new ArrayList<Operation>(_list53.size);
            Operation _elem54;
            for (int _i55 = 0; _i55 < _list53.size; ++_i55)
            {
              _elem54 = new Operation();
              _elem54.read(iprot);
              struct.operations.add(_elem54);
            }
          }
          struct.setOperationsIsSet(true);
        }
  ...
  public static class replay_result implements org.apache.thrift.TBase<replay_result, replay_result._Fields>, java.io.Serializable, Cloneable, Comparable<replay_result>   {
    ...
    public replay_result setE(DbmsException e) {
      this.e = e;
      return this;
    }
